...
# 训练时的特征顺序（根据提供的顺序）
model_feature_names = ['GGT', 'ALP', 'Height.cm.', 'TG', 'WC', 'Insulin', 'GLU', 'RBC', 'HDL', 'WBC']

# 特征范围定义（根据提供的特征范围和数据类型，已按新的顺序调整）
feature_ranges = {
    "GGT": {"type": "numerical", "min": 1, "max": 70.0, "default": 50},
    "ALP": {"type": "numerical", "min": 30, "max": 650, "default": 50},
